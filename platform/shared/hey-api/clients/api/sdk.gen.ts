 ...
 */
export const getAgentEvals = <ThrowOnError extends boolean = false>(options?: Options<GetAgentEvalsData, ThrowOnError>) => (options?.client ?? client).get<GetAgentEvalsResponses, GetAgentEvalsErrors, ThrowOnError>({ url: '/api/agent-evals', ...options });
 ...
 */
export const createAgentEval = <ThrowOnError extends boolean = false>(options: Options<CreateAgentEvalData, ThrowOnError>) => (options.client ?? client).post<CreateAgentEvalResponses, CreateAgentEvalErrors, ThrowOnError>({
    url: '/api/agent-evals',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 */
export const deleteAgentEval = <ThrowOnError extends boolean = false>(options: Options<DeleteAgentEvalData, ThrowOnError>) => (options.client ?? client).delete<DeleteAgentEvalResponses, DeleteAgentEvalErrors, ThrowOnError>({ url: '/api/agent-evals/{evalId}', ...options });

/**
 * Get a single agent evaluation
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `agentEval:read`: View agent evaluations and results
 */
export const getAgentEval = <ThrowOnError extends boolean = false>(options: Options<GetAgentEvalData, ThrowOnError>) => (options.client ?? client).get<GetAgentEvalResponses, GetAgentEvalErrors, ThrowOnError>({ url: '/api/agent-evals/{evalId}', ...options });

/**
 * Update an agent evaluation
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const updateAgentEval = <ThrowOnError extends boolean = false>(options: Options<UpdateAgentEvalData, ThrowOnError>) => (options.client ?? client).put<UpdateAgentEvalResponses, UpdateAgentEvalErrors, ThrowOnError>({
    url: '/api/agent-evals/{evalId}',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
 ...
 * `agentEval:read`: View agent evaluations and results
 */
export const getAgentEvalCases = <ThrowOnError extends boolean = false>(options: Options<GetAgentEvalCasesData, ThrowOnError>) => (options.client ?? client).get<GetAgentEvalCasesResponses, GetAgentEvalCasesErrors, ThrowOnError>({ url: '/api/agent-evals/{evalId}/cases', ...options });
 ...
 * `agentEval:create`: Create evaluations and trigger eval runs
 */
export const createAgentEvalCase = <ThrowOnError extends boolean = false>(options: Options<CreateAgentEvalCaseData, ThrowOnError>) => (options.client ?? client).post<CreateAgentEvalCaseResponses, CreateAgentEvalCaseErrors, ThrowOnError>({
    url: '/api/agent-evals/{evalId}/cases',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
 ...
 * `agentEval:delete`: Delete evaluations
 */
export const deleteAgentEvalCase = <ThrowOnError extends boolean = false>(options: Options<DeleteAgentEvalCaseData, ThrowOnError>) => (options.client ?? client).delete<DeleteAgentEvalCaseResponses, DeleteAgentEvalCaseErrors, ThrowOnError>({ url: '/api/agent-evals/{evalId}/cases/{caseId}', ...options });
 ...
 * `agentEval:update`: Modify evaluation suites and cases
 */
export const updateAgentEvalCase = <ThrowOnError extends boolean = false>(options: Options<UpdateAgentEvalCaseData, ThrowOnError>) => (options.client ?? client).put<UpdateAgentEvalCaseResponses, UpdateAgentEvalCaseErrors, ThrowOnError>({
    url: '/api/agent-evals/{evalId}/cases/{caseId}',
    ...options,
    headers: {
        'Content-Type': 'application/json',
        ...options.headers
 ...
 * `agentEval:read`: View agent evaluations and results
 */
export const getAgentEvalRuns = <ThrowOnError extends boolean = false>(options: Options<GetAgentEvalRunsData, ThrowOnError>) => (options.client ?? client).get<GetAgentEvalRunsResponses, GetAgentEvalRunsErrors, ThrowOnError>({ url: '/api/agent-evals/{evalId}/runs', ...options });
 ...
 * `agentEval:create`: Create evaluations and trigger eval runs
 */
export const createAgentEvalRun = <ThrowOnError extends boolean = false>(options: Options<CreateAgentEvalRunData, ThrowOnError>) => (options.client ?? client).post<CreateAgentEvalRunResponses, CreateAgentEvalRunErrors, ThrowOnError>({ url: '/api/agent-evals/{evalId}/runs', ...options });
 ...
 * `agentEval:read`: View agent evaluations and results
 */
export const getAgentEvalRun = <ThrowOnError extends boolean = false>(options: Options<GetAgentEvalRunData, ThrowOnError>) => (options.client ?? client).get<GetAgentEvalRunResponses, GetAgentEvalRunErrors, ThrowOnError>({ url: '/api/agent-evals/{evalId}/runs/{runId}', ...options });
