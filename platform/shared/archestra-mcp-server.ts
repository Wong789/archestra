...
export const TOOL_EVAL_AUDIT_SHORT_NAME = "eval_audit";
export const TOOL_EVAL_OBSERVE_SHORT_NAME = "eval_observe";
...
export const TOOL_EVAL_AUDIT_FULL_NAME =
  `${ARCHESTRA_TOOL_PREFIX}${TOOL_EVAL_AUDIT_SHORT_NAME}` as const;
export const TOOL_EVAL_OBSERVE_FULL_NAME =
  `${ARCHESTRA_TOOL_PREFIX}${TOOL_EVAL_OBSERVE_SHORT_NAME}` as const;
