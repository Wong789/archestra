...
CREATE INDEX "internal_mcp_catalog_scope_idx" ON "internal_mcp_catalog" USING btree ("scope");--> statement-breakpoint
CREATE INDEX "internal_mcp_catalog_author_id_idx" ON "internal_mcp_catalog" USING btree ("author_id");