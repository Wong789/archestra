...
| `internalMcpCatalog:team-admin` | Team-level administrative control over the resource internal mcp server catalog management |
| `internalMcpCatalog:admin` | Administrative control over internal mcp server catalog management |
