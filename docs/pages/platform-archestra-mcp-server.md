...
| Tool | Description | Required RBAC Permission |
|------|-------------|--------------------------|
| `eval_audit` | Self-audit tool for agent evaluation. | `agentEval:read` |
| `eval_observe` | Observer tool for post-execution analysis of agent traces. | `agentEval:read` |

#### eval_audit

Required RBAC permission: `agentEval:read`

##### Input

| Parameter | Type | Required | Description |
|-----------|------|----------|-------------|
| `alertName` | `string` | Yes | Name of the alert being investigated |
| `summary` | `string` | Yes | Brief summary of the investigation |
| `delegations` | `object[]` | No | Sub-agent delegations made during investigation |
| `delegations[].toAgent` | `string` | Yes |  |
| `delegations[].task` | `string` | No |  |
| `toolCalls` | `string[]` | No | Names of tools called during investigation |
| `finalResponse` | `string` | Yes | The final response/conclusion |
...
|-------|------|----------|-------------|
| `triage` | `object` | Yes |  |
| `triage.score` | `number` | Yes |  |
| `triage.reasoning` | `string` | Yes |  |
| `investigation` | `object` | Yes |  |
| `investigation.score` | `number` | Yes |  |
| `investigation.reasoning` | `string` | Yes |  |
| `rootCause` | `object` | Yes |  |
| `rootCause.score` | `number` | Yes |  |
| `rootCause.reasoning` | `string` | Yes |  |
| `remediation` | `object` | Yes |  |
| `remediation.score` | `number` | Yes |  |
| `remediation.reasoning` | `string` | Yes |  |
| `passed` | `boolean` | Yes |  |
...
| Parameter | Type | Required | Description |
|-----------|------|----------|-------------|
| `traceId` | `string` | Yes | Trace/session ID for the agent execution |
| `toolCalls` | `object[]` | Yes | Tool calls from the agent execution |
| `toolCalls[].toolName` | `string` | Yes |  |
| `toolCalls[].args` | `object` | No |  |
| `toolCalls[].result` | `string` | No |  |
| `finalResponse` | `string` | Yes | The agent's final response |
...
|-------|------|----------|-------------|
| `scores` | `object` | Yes |  |
| `scores.alertUnderstanding` | `number` | Yes |  |
| `scores.investigationQuality` | `number` | Yes |  |
| `scores.delegationEfficiency` | `number` | Yes |  |
| `scores.rootCauseAccuracy` | `number` | Yes |  |
| `scores.remediationQuality` | `number` | Yes |  |
| `analysis` | `object` | Yes |  |
| `analysis.overallAssessment` | `string` | Yes |  |
| `analysis.missedOpportunities` | `string[]` | Yes |  |
| `analysis.unnecessaryActions` | `string[]` | Yes |  |
| `passed` | `boolean` | Yes |  |
