...
| `policies[].matchTemplate` | `string` | Yes | Handlebars match template. |
| `policies[].sortOrder` | `number` | Yes | Rule evaluation order. |
...
| `matchTemplate` | `string` | No | Optional Handlebars match template. If omitted, conditions are converted automatically. |
| `sortOrder` | `integer` | No | Rule evaluation order. Lower values run first. |
...
| `policy.matchTemplate` | `string` | Yes | Handlebars match template. |
| `policy.sortOrder` | `number` | Yes | Rule evaluation order. |
...
| `conditions[].operator` | `"equal" \| "notEqual" \| "contains" \| "notContains" \| "startsWith" \| "endsWith" \| "regex"` | Yes | The comparison operator. |
| `conditions[].value` | `string` | Yes | The value to compare against. |
| `matchTemplate` | `string` | No | Updated Handlebars match template. |
| `sortOrder` | `integer` | No | Updated rule evaluation order. |
...
| `policies[].matchTemplate` | `string` | Yes | Handlebars match template. |
| `policies[].sortOrder` | `number` | Yes | Rule evaluation order. |
| `policies[].action` | `"assign_labels" \| "block_always" \| "mark_as_trusted" \| "mark_as_untrusted" \| "sanitize_with_dual_llm"` | Yes | The policy action. |
| `policies[].labels` | `string[]` | Yes | Labels applied by the policy, if any. |
...
| `matchTemplate` | `string` | No | Optional Handlebars match template. If omitted, conditions are converted automatically. |
| `sortOrder` | `integer` | No | Rule evaluation order. Lower values run first. |
| `action` | `"assign_labels" \| "block_always" \| "mark_as_trusted" \| "mark_as_untrusted" \| "sanitize_with_dual_llm"` | Yes | The action to take when the policy matches. |
| `labels` | `string[]` | No | Labels to attach when action is `assign_labels`. |
...
| `policy.matchTemplate` | `string` | Yes | Handlebars match template. |
| `policy.sortOrder` | `number` | Yes | Rule evaluation order. |
| `policy.action` | `"assign_labels" \| "block_always" \| "mark_as_trusted" \| "mark_as_untrusted" \| "sanitize_with_dual_llm"` | Yes | The policy action. |
| `policy.labels` | `string[]` | Yes | Labels applied by the policy, if any. |
...
| `matchTemplate` | `string` | No | Updated Handlebars match template. |
| `sortOrder` | `integer` | No | Updated rule evaluation order. |
| `action` | `"assign_labels" \| "block_always" \| "mark_as_trusted" \| "mark_as_untrusted" \| "sanitize_with_dual_llm"` | No | Updated action to take when the policy matches. |
| `labels` | `string[]` | No | Updated labels to attach when action is `assign_labels`. |
